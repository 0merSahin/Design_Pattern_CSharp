...
{
	public class PriceType1_FM_13 : IPrice_FM_13, ICargo_FM_13
	{
        public int CalculatePrice(SqlConnection connection, List<int> ProductIDList, int CargoDistance)
        {
            ...
            try
            {
                ...
                reader.Close();
                connection.Close();
                price += CalculateCargoPrice(CargoDistance);
                return price;
            }
        ...
        public int CalculateCargoPrice(int distance)
        {
            if (distance > 300) return 90;
            else if (distance > 150) return 70;
            else return 20;
        }
    }
}
